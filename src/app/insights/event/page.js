...
async function getContent() {
    ...
    try {
        ...
        // Try internal API call (server-side) first
        if (isServer) {
            try {
                ...
                const mockParams = Promise.resolve({ section: 'events' });
        ...
        const apiUrl = `${baseUrl}/api/content/events`;
